...
(function (Scratch) {
  ...
  const iconURI =
    "https://itswiktoragain.github.io/extensions-well-thats-quite-new/itswiktoragain/scratch-api-icon.svg";
  ...
  class ScratchAPI {
    ...
    getInfo() {
      return {
        ...
        blocks: [
          ...
          {
            blockType: BlockType.LABEL,
            text: Scratch.translate("Projects"),
          },
          {
            opcode: "projectField",
            blockType: BlockType.REPORTER,
          ...
          {
            blockType: BlockType.LABEL,
            text: Scratch.translate("Studios"),
          },
          {
            opcode: "studioField",
            blockType: BlockType.REPORTER,
          ...
          {
            blockType: BlockType.LABEL,
            text: Scratch.translate("Discover"),
          },
          {
            opcode: "search",
            blockType: BlockType.REPORTER,
    ...
    projectList(args) {
      ...
      return this.json(
        `/projects/${encode(args.ID)}/${type}?limit=${limit(args.LIMIT)}&offset=${offset(args.OFFSET)}`
      );
    }
